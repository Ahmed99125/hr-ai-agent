...
2. **الإجازات | Leave**: فحص الرصيد، الاستحقاق القانوني، طلب الإجازة، الموافقة
3. **الإجراءات | SOPs**: البحث في دليل السياسات، تسجيل فجوات التشغيل
4. **الأداء | Performance**: تسجيل التقييم اليومي للفريق، الملخص الأسبوعي
5. **الاستقبال | Onboarding**: جمع المستندات، قوائم التحقق في BambooHR، جداول التوجيه، الإجابة على أسئلة القانون
